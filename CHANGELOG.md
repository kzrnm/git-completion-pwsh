...
## [2.0.0] - 2026-08-08
### Changed
- **Breaking Change** Remove implicit `Register-ArgumentCompleter`

## [1.6.0] - 2026-08-07
### Added
- Add missing completion for log `--max-count-oldest`
- Add descriptions for `remote.*.negotiationInclude` and `remote.*.negotiationRestrict`
### Changed
- Consolidate the implementation into the .psm1 file to reduce file loading
